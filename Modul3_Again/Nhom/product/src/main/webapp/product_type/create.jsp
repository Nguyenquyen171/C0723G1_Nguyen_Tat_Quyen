...
<div class="row m-4 ">
    ...
    <div class="col-md-6 " style="float: right">
        ...
        <form  action="/product_type_manager" method="post" class="b1">
            <div class="mb-3 row">
            ...
            <button name = "action" value="create" type="submit" class="btn btn-danger" style="width: 23%; text-transform: uppercase;font-weight: 600 ; font-size: 12px;
            font-family: 'Roboto', sans-serif;">
                Thêm mới
            </button>
        </form>
