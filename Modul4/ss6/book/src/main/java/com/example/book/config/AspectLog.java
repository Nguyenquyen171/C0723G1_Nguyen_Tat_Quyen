...
import com.example.book.utils.FileUtils;
...
public class AspectLog {
    ...
    @Pointcut("execution(* com.example.book.controller.RentalController.rentalBook(..))")
    public void rentalBook(){}

    @Pointcut("execution(* com.example.book.controller.RentalController.giveBookBack(..))")
